<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FormTambahDokumen.aspx.cs" Inherits="mppl.FormTambah" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Button ID="UploadBtn" runat="server" onclick="UploadClick" Text="Submit" />
    <br />
