...
namespace OjopodoTestProject
{
    ...
    public class _DefaultTest
    {
        ...
        [UrlToTest("http://localhost:1904/")]
        [DeploymentItem("mppl.dll")]
        public void btn_mulai_ClickTest1()
        {
            _Default_Accessor target = new _Default_Accessor(); // TODO: Initialize to an appropriate value
            object sender = null; // TODO: Initialize to an appropriate value
            EventArgs e = null; // TODO: Initialize to an appropriate value
        ...
        [AspNetDevelopmentServerHost("C:\\Users\\Admin\\Documents\\Visual Studio 2010\\Projects\\OjoPodo\\mppl\\mppl", "/")]
        [UrlToTest("http://localhost:1904/")]
        public void _DefaultConstructorTest2()
        {
            _Default target = new _Default();
            Assert.Inconclusive("TODO: Implement code to verify target");
        }
        ...
        [UrlToTest("http://localhost:1904/")]
        [DeploymentItem("mppl.dll")]
        public void btn_mulai_ClickTest2()
        {
            _Default_Accessor target = new _Default_Accessor(); // TODO: Initialize to an appropriate value
            object sender = null; // TODO: Initialize to an appropriate value
            EventArgs e = null; // TODO: Initialize to an appropriate value
