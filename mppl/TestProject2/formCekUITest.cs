...
namespace TestProject2
{
    ...
    public class formCekUITest
    {
        ...
        [AspNetDevelopmentServerHost("D:\\TIAN\\KULIAH\\SEMESTER 6\\MPPL\\FP\\mppl\\mppl", "/")]
        [UrlToTest("http://localhost:1904/")]
        public void pilihModeFileTest()
        {
            formCekUI target = new formCekUI(); // TODO: Initialize to an appropriate value
            target.pilihModeFile();
            Assert.Inconclusive("A method that does not return a value cannot be verified.");
        }

        /// <summary>
        ///A test for pilihModeTeks
        ///</summary>
        // TODO: Ensure that the UrlToTest attribute specifies a URL to an ASP.NET page (for example,
        // http://.../Default.aspx). This is necessary for the unit test to be executed on the web server,
        // whether you are testing a page, web service, or a WCF service.
        ...
        [AspNetDevelopmentServerHost("D:\\TIAN\\KULIAH\\SEMESTER 6\\MPPL\\FP\\mppl\\mppl", "/")]
        [UrlToTest("http://localhost:1904/")]
        public void pilihModeTeksTest()
        {
            formCekUI target = new formCekUI(); // TODO: Initialize to an appropriate value
            target.pilihModeTeks();
            Assert.Inconclusive("A method that does not return a value cannot be verified.");
        }

        /// <summary>
        ///A test for tekanTombolCek
        ///</summary>
        // TODO: Ensure that the UrlToTest attribute specifies a URL to an ASP.NET page (for example,
        // http://.../Default.aspx). This is necessary for the unit test to be executed on the web server,
        // whether you are testing a page, web service, or a WCF service.
        ...
        [AspNetDevelopmentServerHost("D:\\TIAN\\KULIAH\\SEMESTER 6\\MPPL\\FP\\mppl\\mppl", "/")]
        [UrlToTest("http://localhost:1904/")]
        public void tekanTombolCekTest()
        {
            formCekUI target = new formCekUI(); // TODO: Initialize to an appropriate value
            target.tekanTombolCek();
            Assert.Inconclusive("A method that does not return a value cannot be verified.");
        }
    }
}
